...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # ! Fullscreen code below. Remove the set_mode above.
    ...
    def _start_game(self):
        '''Reset game statistics, fleet and ship.'''
    ...
    def _check_bullet_alien_collisions(self):
        '''Check for any bullets that have hit aliens, if so get rid of them.'''
    ...
    def _start_new_level(self):
        '''Set up the next level once all aliens are destroyed.'''
        self.bullets.empty()
        self._create_fleet()
